...
public class createaccount2 {
    public static void main(String[] args) throws InterruptedException {
        ...
        emailbox1.sendKeys("jannat78@gmail.com");
